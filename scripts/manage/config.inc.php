...
$config['db_addr'] = 'localhost'; // The location of the DB
$config['db_user'] = 'oncite'; // The MySQL user used to access the database
$config['db_pass'] = 'oncite'; // The MySQL password used to access the database
$config['db_db'] = 'ime_oncite'; // The database name

// Settings which tell us WHERE the system has been installed
// URLs must end with a slash
$config['scriptshomeurl'] = 'scripts/';
$config['imageshomeurl'] = '../';
$config['pageshomeurl'] = '../'; 
$config['homedir'] = '/var/www/oncite/scripts/'; // Filesystem path to the "scripts" directory
...
$config['webmasteremail'] = 'rafaelperazzo@gmail.com'; // Full email address of pubs-system administrator
$config['emaildomain'] = ''; // What to append, to convert an Apache user ID to an email address
$config['institutionname'] = 'Instituto de Matematica e Estatisca - IME/USP'; // Short name for the institution

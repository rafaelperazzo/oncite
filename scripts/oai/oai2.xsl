...
<!-- These extra elements added by Dan, to match UCL eprints' scheme -->

<xsl:template match="dc:relation.isFormatOf" xmlns:dc="http://purl.org/dc/elements/1.1/">
<tr><td class="key">Title of containing journal/book/conference</td><td class="value"><xsl:value-of select="."/></td></tr></xsl:template>

<xsl:template match="dc:relation.isFormatOf.volume" xmlns:dc="http://purl.org/dc/elements/1.1/">
<tr><td class="key">Volume</td><td class="value"><xsl:value-of select="."/></td></tr></xsl:template>

<xsl:template match="dc:relation.isFormatOf.number" xmlns:dc="http://purl.org/dc/elements/1.1/">
<tr><td class="key">Issue</td><td class="value"><xsl:value-of select="."/></td></tr></xsl:template>

<xsl:template match="dc:relation.isFormatOf.pageRange" xmlns:dc="http://purl.org/dc/elements/1.1/">
<tr><td class="key">Pages</td><td class="value"><xsl:value-of select="."/></td></tr></xsl:template>

<!-- End of extra elements added by Dan -->
